namespace HW1ClassesHierarchy
{
    ...
    {
        public DigitalSource(string name, string description, bool isFreeSourse, string author, PublicationFormatEnum publicationFormat)
        ...
        public PublicationFormatEnum PublicationFormat { get; }
